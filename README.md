...
For more information you can read [the full SDK guide](https://github.com/paperrose/InAppStorySdkKt/blob/master/docs/Index.md), [FAQ](https://github.com/paperrose/InAppStorySdkKt/blob/master/docs/FAQ.md) or check [Samples](https://github.com/paperrose/InAppStorySdkKt/blob/master/docs/Index.md).
